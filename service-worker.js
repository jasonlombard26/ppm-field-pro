const CACHE='ppm-field-pro-v2';
const APP=['./','./index.html','./manifest.webmanifest','./icons/icon-192.svg','./icons/icon-512.svg','./app-payload-1.txt','./app-payload-2.txt','./app-payload-3.txt','./app-payload-4.txt'];
